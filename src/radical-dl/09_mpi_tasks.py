...
if __name__ == '__main__':
    ...
    try:
        ...
        pd_init = {
                   ...
                   'access_schema' : config[resource].get('schema',  "interactive"),
                   'cores'         : config[resource].get('cores',   1),
                   'gpus'          : config[resource].get('gpus',    2),
                  }
        ...
        for i in range(0, 1):
            ...
            td.executable       = '/project/bii_dsc_community/djy8hg/arupcsedu/cylonplus/rp_dl/bin/python'
            td.arguments        = ['single-gpu-cnn.py']
            td.input_staging    = ['%s/single-gpu-cnn.py' % PWD]
            #td.ranks            = p_num
